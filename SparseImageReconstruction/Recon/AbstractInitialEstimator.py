...
class InitialEstimatorFactory(object):
    ...
    def GetInitialEstimator(initialEstimatorDesc):
        if initialEstimatorDesc not in InitialEstimatorFactory._concreteInitialEstimator:
            raise NotImplementedError('InitialEstimator ' + str(initialEstimatorDesc) + ' isn\'t implemented' )
