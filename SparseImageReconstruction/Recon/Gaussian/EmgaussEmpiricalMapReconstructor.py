...
class EmgaussEmpiricalMapReconstructor(AbstractEmgaussReconstructor):
    def __init__(self, optimSettingsDict, estHyperparameterObj, dynamicThresholdingObj):
        ...
        assert (
            AbstractEmgaussReconstructor.INPUT_KEY_ESTIMATE_HYPERPARAMETERS_ITERATIONS_INTERVAL
            in optimSettingsDict
        )
        assert (
            optimSettingsDict[
                AbstractEmgaussReconstructor.INPUT_KEY_ESTIMATE_HYPERPARAMETERS_ITERATIONS_INTERVAL
    ...
    def EstimateHyperparameter(self, reconArgsN):
        ...
        self._hyperparameter = self._estHyperparameterObj.EstimateHyperparameter(
            reconArgsN
        )
    ...
    def UpdateThresholder(self):
        ...
        self._thresholder = self._dynamicThresholdingObj.GetDynamicThreshold(
            ...
            alphaVal=self._optimSettingsDict[
                AbstractEmgaussReconstructor.INPUT_KEY_ALPHA
            ],
        )
