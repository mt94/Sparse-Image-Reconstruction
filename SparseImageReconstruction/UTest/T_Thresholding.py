...
class T_Thresholding(unittest.TestCase):
    ...
    def testIdentity(self):
        ...
        self.assertTrue(
            np.array_equal(randomValues, t.Apply(randomValues)),
            "Thresholding id failed",
        )
    ...
    def testSoft(self):
        ...
        self.assertTrue(
            np.array_equal(
                np.array([-1, 0, 0, 1]), t.Apply(np.array([-2, -0.5, 0.5, 2]))
            ),
    ...
    def testHard(self):
        ...
        self.assertTrue(
            np.array_equal(
                np.array([-2, 0, 0, 2]), t.Apply(np.array([-2, -0.5, 0.5, 2]))
            ),
    ...
    def testHybrid(self):
        ...
        self.assertTrue(
            np.array_equal(
                np.array([-1.5, 0, 0, 1.5]), t.Apply(np.array([-2, -0.5, 0.5, 2]))
            ),
