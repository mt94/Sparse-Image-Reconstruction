...
class AbstractImageGenerator(chb.AbstractChannelBlock):
    ...
    def __init__(self):
        super(AbstractImageGenerator, self).__init__(
            AbstractImageGenerator.CHANNEL_BLOCK_TYPE
        )
    ...
    def SetParameters(self, **kwargs):
        ...
        assert (self.numNonzero >= 0) and (
            self.numNonzero < self.imageShape[0] * self.imageShape[1] * 0.5
        )
