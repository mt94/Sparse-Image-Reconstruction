...
class LarsReconstructorFactory(object):
    ...
    def GetReconstructor(reconstructorDesc, optimSettingsDict):
        if reconstructorDesc not in LarsReconstructorFactory._concreteReconstructorGenerator:
            raise NotImplementedError("Reconstructor " + str(reconstructorDesc) + " isn't implemented")
        return LarsReconstructorFactory._concreteReconstructorGenerator[reconstructorDesc](optimSettingsDict)
